<?php
	...
	// reading blacklist id and adding one on it 
		...
		$sql="UPDATE Company SET Company.CumulativeBlacklists=1";// WHERE CompanyID=$updateCompanyID"; 
	        // mysqli_execute($con,$sql);
	...
	$sql="INSERT INTO Blacklist (BlacklistID, UserName, CompanyID, StartBlacklist, AmountOnStart, Description, DeleteFlag) 
	       VALUES ('$largestID', '$_SESSION[username] ', ' $_POST[companyID] ','  $date  ',' $_POST[currentBalance] ',' $_POST[description] ','1')";

...
<?php	
	...
	$sql="SELECT Company.CompanyID,CompanyName,Street,Town,County,CreditLimit,CurrentBalance,CumulativeBlacklists FROM Company LEFT JOIN Blacklist ON Company.CompanyID=Blacklist.CompanyID WHERE Blacklist.DeleteFlag=0 OR Blacklist.DeleteFlag IS null AND Company.DeleteFlag=0";
